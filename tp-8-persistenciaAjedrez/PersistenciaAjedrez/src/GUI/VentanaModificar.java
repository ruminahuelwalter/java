...
public class VentanaModificar extends JFrame implements ActionListener, ItemListener {
    ...
    public VentanaModificar(String idPieza, Tabla tabla) {
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (e.getSource() == botonAceptar) {
            ...
            iPiezaA.modificarElemento(pieza, idPieza);
